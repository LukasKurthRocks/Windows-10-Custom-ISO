...
if %EditionPro%==1 (
if %ServerRdsh%==0 echo. 10. Enterprise for Remote Sessions
)
echo.
echo ============================================================
echo Options:
...
"%dismroot%" /English /Mount-Image /ImageFile:ISOFOLDER\sources\install.wim /Index:%source% /MountDir:%SystemDrive%\MountUUP
...
"%dismroot%" /English /Image:"%mountdir%" /Set-Edition:%name%
SET ERRORTEMP=%ERRORLEVEL%
IF %ERRORTEMP% NEQ 0 (
"%dismroot%" /English /Unmount-Image /MountDir:"%mountdir%" /Discard 1>nul 2>nul
"%dismroot%" /English /Cleanup-Mountpoints 1>nul 2>nul
...
if /i "%name%" equ "Enterprise" (
"%dismroot%" /English /Image:"%mountdir%" /Set-ProductKey:NPPR9-FWDCX-D2C8J-H872K-2YT43
)
if /i "%name%" equ "EnterpriseN" (
"%dismroot%" /English /Image:"%mountdir%" /Set-ProductKey:DPH2V-TTNVB-4X9Q3-TJR4H-KHJW4
)
if /i "%name%" equ "ServerRdsh" (
"%dismroot%" /English /Image:"%mountdir%" /Set-ProductKey:7NBT4-WGBQX-MP4H7-QXFF8-YP3KX
)
