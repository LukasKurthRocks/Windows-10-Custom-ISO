...
PowerShell.exe -NoLogo -NoProfile -ExecutionPolicy ByPass -Command "%~dp02._CreateEditions.ps1" -WindowsEditions Enterprise -CustomWIMFileName "OnlyEnterprise.wim"
